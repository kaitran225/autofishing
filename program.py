...
class OverlayAutoFisher(QMainWindow):
    ...
    def start(self):
        ...
        # In a real implementation, we would start the detection thread here
        # For now, we'll just update the preview more frequently
        if self.preview_timer:
            self.preview_timer.setInterval(200)  # Update more frequently when active
